...
QToolButton[dashboardNav="true"][active="true"] {{
    background: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #2a6fbd, stop:1 #174c8b);
    color: #ffffff;
...
# v7.3.1-compatible responsive overrides for the committee client.
MAIN_STYLESHEET += """
QWidget[responsiveProfile="compact"] { font-size: 10pt; }
QWidget[responsiveProfile="comfortable"] { font-size: 10.5pt; }
QWidget[responsiveProfile="spacious"] { font-size: 11pt; }
...
QWidget[responsiveProfile="comfortable"] QSpinBox { min-height: 38px; }
...
QWidget[responsiveProfile="spacious"] QSpinBox { min-height: 42px; }
QWidget[responsiveProfile="compact"] QTabBar::tab {
    min-height: 30px; padding: 7px 10px; font-size: 9.5pt;
}
QWidget[responsiveProfile="comfortable"] QTabBar::tab {
    min-height: 34px; padding: 8px 13px; font-size: 10pt;
}
QWidget[responsiveProfile="spacious"] QTabBar::tab {
    min-height: 38px; padding: 9px 16px; font-size: 10.5pt;
}
"""
